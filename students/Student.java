...
public class Student implements StudentComparable {
    ...
    public double getMathsGrade() { return mathsGrade; }
    ...
    public String toString() {
        return lastname + ", " + firstname + ", " + yearOfBirth + ", " + String.format("%.2f", getAverageGrade());
    }

    @Override
    public int compareTo(Student another) {
        int first = this.firstname.compareTo(another.firstname);
        return (first != 0) ? first : this.lastname.compareTo(another.lastname);
    }
}